...
//marketing
Route::group(['middleware' => ['checksession','markettype']], function () {
	Route::get('/mlogout','marketlogoutController@index')->name('market.logout');
	...
	Route::post('/check', 'MarketUserController@duplicate')->name('checkduplicate');
